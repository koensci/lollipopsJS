var lollipopsJS = {
    ...
    displayPfamError: function() {
        this.resetPainter();
        this.painter.font = "60px sans-serif";
        this.painter.fillText("Error retrieving domains from Pfam.", 2000, 350);
    },
